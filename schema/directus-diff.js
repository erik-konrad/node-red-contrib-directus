const {createDirectus, staticToken, serverPing, rest, schemaDiff} = require('@directus/sdk');


module.exports = function(RED) {
    function DirectusDiffNode(config) {
        ...
        node.on('input', async function(msg) {
            ...
            try {
                const response = await client.request(schemaDiff(msg.payload, config.force || false));
    ...
    RED.nodes.registerType('directus-diff', DirectusDiffNode);
}